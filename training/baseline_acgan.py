...
def train():
    ...
    run_id = 1
    epochs = 500
    model_save_dir = os.path.join('./saved_models/baseline_acgan/', folder_name_mapping[dataset], 'run_' + str(run_id))
    if not os.path.exists(model_save_dir):
        os.makedirs(model_save_dir)

    output_dir = os.path.join('./outputs/baseline_acgan/', folder_name_mapping[dataset], 'run_' + str(run_id))
